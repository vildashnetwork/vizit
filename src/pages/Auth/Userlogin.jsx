...
export default function UserAuthLanding() {
    ...
    const { signup, isSigningUp, login, isLoggingIn, loginsucesss } = useAuthStore();
    ...
    const data = { name: fullName, number: phone, email: regEmail, password: regPassword, interest: role }
                ...
                {mode === "login" ? (
                    ...
                    <form className="landing__form" onSubmit={handleLogin} noValidate>
                        ...
                        <button className="btn btn--owner" type="submit" disabled={isLoggingIn}>
                            {isLoggingIn ? "Signing in..." : "Login as User"}
                        </button>
                    </form>
